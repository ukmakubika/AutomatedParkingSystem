...
namespace AutomatedTicketSystemProject_Group6
{
    public partial class AddCard : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                txtExpDate.Text = cbYear.Text + cbMonth.Text;
                string dateExp = txtExpDate.Text;
                var parsedExp = DateTime.Parse(dateExp);

                name = txtCardholderName.Text;

                string addme = $"INSERT INTO BANK(Bank_name, Exp_date, Card_no, Card_HolderName) VALUES('{cbBankNames.Text}', '{txtCardNo.Text}', {parsedExp:Y},'{txtCardholderName.Text}')";//tell to insert in string language
